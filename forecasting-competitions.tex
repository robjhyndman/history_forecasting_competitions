...
Prediction competitions go back millenia, with rival Greek diviners competing to predict the future more accurately \autocite[p124]{Raphals2013}. However, for general time series forecasting, the history is much more limited, and only goes back about 50 years.
...
\hypertarget{early-controversy}{%
\section{Early controversy}\label{early-controversy}}
